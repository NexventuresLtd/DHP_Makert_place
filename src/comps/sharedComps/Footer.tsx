              ...
              <div className="mb-6 sm:mb-8">
                ...
                <div className="space-y-3 sm:space-y-0 sm:flex sm:gap-2">
                  <input
                    ...
                    className="w-full hidden sm:flex-1 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-transparent text-sm sm:text-base"
                  />
                  <button
