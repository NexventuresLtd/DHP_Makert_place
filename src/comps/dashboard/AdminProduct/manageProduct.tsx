...
import { PlusCircle, Trash2, Star, Filter, Search, Loader2, ChevronLeft, ChevronRight, AlertCircle, ImageIcon, Eye, Edit } from "lucide-react";
                                            ...
                                            <tr key={product.id} className="hover:bg-gray-50" >
                                                    ...
                                                    <div className="flex-shrink-0 h-10 w-10">
                                                        {product.images.length > 0 ? (
                                                            <img
                                                                ...
                                                                alt={product.name}
                                                                onError={(e) => {
                                                                    (e.target as HTMLImageElement).src = "logos/logo-circle.png"; // Fallback image
                                                                }}
                                                            />
                                                        ) : (
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex flex-col gap-1">
                                                        <span className={`px-2 py-1 text-xs rounded-full w-fit ${product.is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                                            }`}>
                            ...
                            <AddProductForm
                                ...
                                productToEdit={
                                    selectedProduct
                                        ? {
                                            ...selectedProduct,
                                            uploaded_images: selectedProduct.images.map(img => img.image)
                                        }
                                        : undefined
                                }
                            />
