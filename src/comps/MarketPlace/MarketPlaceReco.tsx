            ...
            {products.length > 0 ? (
              ...
              >
                {products.map((product) => (
                  <div
                    key={product.id}
                    className={`group bg-white/80 backdrop-blur-sm rounded-3xl hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500 overflow-hidden border border-white/20 hover:-translate-y-2 hover:bg-white/90 ${
                      viewMode === 'list' ? 'flex' : ''
                    }`}
                  >
                    ...
                    >
                      <div
                        className={`bg-gradient-to-br from-slate-100 via-slate-50 to-slate-100 flex items-center justify-center relative ${
                          viewMode === 'list' ? 'w-full h-full rounded-l-3xl' : 'aspect-square rounded-t-3xl'
                        }`}
                      >
                        <img
