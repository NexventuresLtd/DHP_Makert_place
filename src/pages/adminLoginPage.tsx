            ...
            .then(response => {
                ...
                if (rememberMe) {
                    ...
                    localStorage.setItem("userInfo", JSON.stringify({
                        "username": username,
                        "type": "admin", // Changed from "user" to "admin" for admin panel
                    }));
                } else {
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="flex justify-end mb-2">
                    <div className="bg-green-100 text-primary text-xs font-medium px-2.5 py-0.5 rounded-full flex items-center">
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="bg-slate-900 text-white px-6 py-3">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs opacity-80">v1 nx</span>
                        </div>
                    </div>
                    ...
                    <div className="p-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    type="button"
                                    className="text-sm text-green-600 hover:text-primary font-medium transition-colors"
